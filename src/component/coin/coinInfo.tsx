...
export const CoinInfo = ({ coinData }: Props) => {
  ...
  return (
    ...
    <div className={`flex flex-col gap-3 item-center duration-700 bg-[rgba(0,0,0,0.6)] ${show? "w-[200px] opacity-1 translate-x-0" : " -translate-x-[200px] delay-300 transition-translate w-0 opacity-0"}  text-[#f5f5f5] py-3 px-2 rounded-br-md rounded-tr-md`}>
